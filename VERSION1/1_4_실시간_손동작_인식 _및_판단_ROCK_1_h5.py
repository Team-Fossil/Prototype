...
# 학습된 모델 로드
model_save_path = '/Users/apple/Desktop/Python/2nd_Grade/Commpetition/Prototype/rock_gesture_model.h5'  # 경로 수정
        ...
        if results.multi_hand_landmarks:
            for hand_landmarks in results.multi_hand_landmarks:
                ...
                for i in range(len(joint_ids) - 1):
                    ...
                    angle_rad = math.atan2(math.sqrt((y2 - y1) ** 2 + (z2 - z1) ** 2), x2 - x1)  # math.atan2로 변경
                    angle_deg = round(math.degrees(angle_rad), 2)  # math.degrees로 변경하고 소수점 둘째 자리까지 반올림
